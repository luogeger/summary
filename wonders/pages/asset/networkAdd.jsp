...
<div class="row-fluid operation operation-resource">
	...
	<div class="col-sm-12 operation-btn">
		<button type="button"  data-value="submit" onclick="addNetwork()" class="btn btn-info btn-sm" >确定</button>
...
<script>
	$(function(){
		...
		//设备类型
		initAssetTypeSelects("assetType-add", {category:NETWORK}, "manufacturer-add", "model-add");
		//数据中心
