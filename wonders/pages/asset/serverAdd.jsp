...
<div class="row-fluid operation operation-resource">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-9 col-sm-8 col">
			<select id="assetType-add" onchange="loadConfiguration(null,'assetType-add');changeModel()" class="form-control input-sm selectpicker input-group-select input-add">
            </select>
		</div>
	</div>
	<div class="col-md-6 col-sm-6">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-9 col-sm-8 col">
			<select id="osType-add" class="form-control input-sm selectpicker input-group-select">
            </select>
		</div>
	</div>
	<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-9 col-sm-8 col">
			<select id="osVersion-add" class="form-control input-sm selectpicker input-group-select">
            </select>
		</div>
	</div>
	<div class="col-md-6 col-sm-6">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-9 col-sm-8 col">
			<select id="datacenter-add" class="form-control input-sm selectpicker input-group-select">
            </select>
		</div>
	</div>
	<div class="col-md-6 col-sm-6">
		...
		<div class="col-md-9 col-sm-8 col">
			<select id="computerRoom-add" class="form-control input-sm selectpicker input-group-select">
            </select>
		</div>
	</div>
	<div class="col-md-6 col-sm-6">
	...
	<div class="col-sm-12 operation-btn">
		<button type="button"  data-value="submit" onclick="addServer()" class="btn btn-info btn-sm" >确定</button>
...
<script>
	$(function(){
		...
		//设备类型
		initAssetTypeSelects("assetType-add", {category:SERVER}, "manufacturer-add", "model-add");
		//资源池
		initPoolSelects("resourcePool-add",{type:COMPUTE_POOL_TYPE});
		//osType
		initOsTypeSelects("osType-add", null,"osVersion-add");
		//数据中心
	...
	function addServer(){
		...
		var osType = $("#osType-add").val();
		var osVersion = $("#osVersion-add").val();
		...
		//console.log($("#model-add").find("option:selected").attr("units"));
		...
		$.ajax({
				type: 'post',
				url: "server-device/create",
				data: data,
				dataType: 'json',
	            success: function (data) {
	            	if(data.code==200){
	            		toastr.success("计算设备添加成功！");
	            		cancelAdd();
	            	}else {
