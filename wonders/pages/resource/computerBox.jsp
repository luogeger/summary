...
<div class="console-title console-title-border">
    ...
    <h5>资源管理</h5>
    <h5>机柜</h5>
    <a id="return-btn" class="pull-right" type="button" style="text-decoration: none" onclick="loadMainPage('itam-content','pages/')">
...
<div class="row-fluid">
    ...
    <div class="pull-right ">
        <button type="reset" class="btn btn-link icon-plus iconlarge" style="color:#0093c6;text-decoration:none">添加</button>
    ...
    <div class="advanced-search">
        <div class="row">
            ...
            <!---->
            <div class="col-md-4 col-sm-4 col-btn ">
                <div class="col-md-4 col-sm-4 col-xs-4 col-input tc" >
                    <button type="button"  data-value="submit"
                            onclick="doQuery()" class="btn btn-info btn-block " >确定</button>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4 col-input tc" >
                    <button type="button"  data-value="reset" onclick="resetSearchInput()"
                            class="btn btn-primary btn-block ">重置</button>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4 col-input tc" style="padding-right: 0px;">
                    <button type="button"  data-value="submit"
                            onclick="doQuery()" class="btn btn-success btn-block" >导出</button>
                </div>
