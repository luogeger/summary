    ...
    <div class="left-menu">
    	<div class="console-title console-title-border">
            ...
            <h6 id="sub-title" style="display: line-block;">添加</h6>
             <h6 class="icon-reply text-primary pull-right" style="border-left:none;cursor: pointer;" onclick="loadMainPage('itam-content','pages/asset/peripheralList.jsp');">
            返回
            </h6>
        </div>
        <div class="row-fluid operation operation-resource">
			...
			<div class="configurationInfo"></div>
			<div class="col-sm-12 operation-btn">
				<button type="button"  data-value="submit" onclick="deviceAdd();" class="btn btn-info btn-sm" >确定</button>
				<button type="button"  data-value="reset" onclick="loadMainPage('itam-content','pages/asset/peripheralList.jsp');" class="btn btn-primary btn-sm">取消</button>
			</div>
		      </div>
  </div>
    <script>
    	$(function(){
			...
			//设备类型
			initAssetTypeSelects("assetType-add", {category:PERIPHERAL}, "manufacturer-add", "model-add");
			//数据中心
		...
		function deviceAdd(){
			...
			var data = {assetTypeId:assetTypeId, assetCode:assetCode, remark:remark,  
